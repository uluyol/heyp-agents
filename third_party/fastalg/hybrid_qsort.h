...
auto MedianOfThree(RandomIt first, RandomIt last,
...
void QuickSortScratch(RandomIt first, RandomIt last, ScratchIt scratch,
                      Compare comp);
...
RandomIt DistributeForward(T pivot, RandomIt first, RandomIt last,
                           ScratchIt scratch, ptrdiff_t scratch_size,
                           Compare comp) {
  ptrdiff_t larger = 0;
...
// beginning.
template <typename T, typename RandomIt, typename ScratchIt, typename Compare>
RandomIt DistributeBackward(T pivot, RandomIt first, RandomIt last,
                            ScratchIt scratch, ptrdiff_t scratch_size,
                            Compare comp) {
  ptrdiff_t smaller = 0;
  while (first < last) {
...
template <ptrdiff_t kScratchSize, typename RandomIt, typename T,
          typename Compare>
RandomIt HoareLomutoHybridPartition(T pivot, RandomIt first, RandomIt last,
                                    T *scratch, Compare comp) {
  auto pfirst =
