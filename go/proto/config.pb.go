...
type HostFlowStateReporterConfig struct {
	...
	SsBinaryName  *string  `protobuf:"bytes,2,opt,name=ss_binary_name,json=ssBinaryName,def=ss" json:"ss_binary_name,omitempty"`
}
...
func (x *HostFlowStateReporterConfig) GetThisHostAddrs() []string {
	if x != nil {
...
type HostEnforcerConfig struct {
	...
	Device *string `protobuf:"bytes,1,opt,name=device,def=eth0" json:"device,omitempty"`
	// If specified, will periodically dump iptables and tc state here.
	DebugLogDir *string `protobuf:"bytes,2,opt,name=debug_log_dir,json=debugLogDir" json:"debug_log_dir,omitempty"`
}

// Default values for HostEnforcerConfig fields.
const (
	Default_HostEnforcerConfig_Device = string("eth0")
)
...
func (x *HostEnforcerConfig) GetDevice() string {
	if x != nil && x.Device != nil {
		return *x.Device
	}
	return Default_HostEnforcerConfig_Device
}
...
type HostAgentConfig struct {
	...
	FlowTracker            *HostFlowTrackerConfig       `protobuf:"bytes,1,opt,name=flow_tracker,json=flowTracker" json:"flow_tracker,omitempty"`
	SocketToHostAggregator *FlowAggregatorConfig        `protobuf:"bytes,2,opt,name=socket_to_host_aggregator,json=socketToHostAggregator" json:"socket_to_host_aggregator,omitempty"`
	FlowStateReporter      *HostFlowStateReporterConfig `protobuf:"bytes,3,opt,name=flow_state_reporter,json=flowStateReporter" json:"flow_state_reporter,omitempty"`
	Enforcer               *HostEnforcerConfig          `protobuf:"bytes,4,opt,name=enforcer" json:"enforcer,omitempty"`
	Daemon                 *HostDaemonConfig            `protobuf:"bytes,5,opt,name=daemon" json:"daemon,omitempty"`
	DcMapper               *StaticDCMapperConfig        `protobuf:"bytes,6,opt,name=dc_mapper,json=dcMapper" json:"dc_mapper,omitempty"`
}
...
type ClusterServerConfig struct {
	...
	Address       *string `protobuf:"bytes,1,opt,name=address,def=:1415" json:"address,omitempty"`
...
const (
	Default_ClusterServerConfig_Address       = string(":1415")
...
var file_heyp_proto_config_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x62, 0x70, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x3a, 0x07, 0x35, 0x30, 0x30,
	0x30, 0x30, 0x30, 0x30, 0x52, 0x0c, 0x6d, 0x69, 0x6e, 0x44, 0x65, 0x6d, 0x61, 0x6e, 0x64, 0x42,
	...
	,
	...
	,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x18, 0x05, 0x20,
	...
	0x64, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x22, 0x61, 0x0a, 0x13, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1f, 0x0a,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x3a, 0x05,
	0x3a, 0x31, 0x34, 0x31, 0x35, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x29,
	...
	0x72, 0x6f, 0x6c, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x22, 0xda, 0x01, 0x0a, 0x12, 0x43, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x12, 0x49, 0x0a, 0x0f, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61,
	0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x68, 0x65, 0x79, 0x70,
	...
	0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	...
	0x69, 0x67, 0x52, 0x09, 0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x37, 0x0a,
	0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2a, 0x33, 0x0a, 0x14, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x6f, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07,
	0x0a, 0x03, 0x42, 0x57, 0x45, 0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x48, 0x45, 0x59, 0x50, 0x5f,
	0x53, 0x49, 0x47, 0x43, 0x4f, 0x4d, 0x4d, 0x32, 0x30, 0x10, 0x01, 0x42, 0x28, 0x5a, 0x26, 0x67,
...
var file_heyp_proto_config_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_heyp_proto_config_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_heyp_proto_config_proto_goTypes = []interface{}{
	(ClusterAllocatorType)(0),           // 0: heyp.proto.ClusterAllocatorType
	(*DemandPredictorConfig)(nil),       // 1: heyp.proto.DemandPredictorConfig
	(*HostFlowTrackerConfig)(nil),       // 2: heyp.proto.HostFlowTrackerConfig
	(*FlowAggregatorConfig)(nil),        // 3: heyp.proto.FlowAggregatorConfig
	(*HostFlowStateReporterConfig)(nil), // 4: heyp.proto.HostFlowStateReporterConfig
	(*HostEnforcerConfig)(nil),          // 5: heyp.proto.HostEnforcerConfig
	(*HostDaemonConfig)(nil),            // 6: heyp.proto.HostDaemonConfig
	(*StaticDCMapperConfig)(nil),        // 7: heyp.proto.StaticDCMapperConfig
	(*HostAgentConfig)(nil),             // 8: heyp.proto.HostAgentConfig
	(*ClusterAllocatorConfig)(nil),      // 9: heyp.proto.ClusterAllocatorConfig
	(*ClusterServerConfig)(nil),         // 10: heyp.proto.ClusterServerConfig
	(*ClusterAgentConfig)(nil),          // 11: heyp.proto.ClusterAgentConfig
	(*DCMapping)(nil),                   // 12: heyp.proto.DCMapping
}
var file_heyp_proto_config_proto_depIdxs = []int32{
	1,  // 0: heyp.proto.HostFlowTrackerConfig.demand_predictor:type_name -> heyp.proto.DemandPredictorConfig
	1,  // 1: heyp.proto.FlowAggregatorConfig.demand_predictor:type_name -> heyp.proto.DemandPredictorConfig
	12, // 2: heyp.proto.StaticDCMapperConfig.mapping:type_name -> heyp.proto.DCMapping
	2,  // 3: heyp.proto.HostAgentConfig.flow_tracker:type_name -> heyp.proto.HostFlowTrackerConfig
	3,  // 4: heyp.proto.HostAgentConfig.socket_to_host_aggregator:type_name -> heyp.proto.FlowAggregatorConfig
	4,  // 5: heyp.proto.HostAgentConfig.flow_state_reporter:type_name -> heyp.proto.HostFlowStateReporterConfig
	5,  // 6: heyp.proto.HostAgentConfig.enforcer:type_name -> heyp.proto.HostEnforcerConfig
	6,  // 7: heyp.proto.HostAgentConfig.daemon:type_name -> heyp.proto.HostDaemonConfig
	7,  // 8: heyp.proto.HostAgentConfig.dc_mapper:type_name -> heyp.proto.StaticDCMapperConfig
	0,  // 9: heyp.proto.ClusterAllocatorConfig.type:type_name -> heyp.proto.ClusterAllocatorType
	3,  // 10: heyp.proto.ClusterAgentConfig.flow_aggregator:type_name -> heyp.proto.FlowAggregatorConfig
	9,  // 11: heyp.proto.ClusterAgentConfig.allocator:type_name -> heyp.proto.ClusterAllocatorConfig
	10, // 12: heyp.proto.ClusterAgentConfig.server:type_name -> heyp.proto.ClusterServerConfig
